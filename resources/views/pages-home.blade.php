...
<body>
    <header>
        <div class="container-fluid" id="background_header_image">
            ...
            <div class="py-5 mt-5">
                <h3 class="text-center text-white">Ride every wave as if it's your last</h3>
                            ...
                            <div class="card-body">
                                <div class="container-fluid">
                                            ...
                                            <div>
                                                ...
                                                <button class="btn-link border-0 buttons_and_links">Buy now</button>
                                            </div>
                                </div>
                            </div>
            ...
            <div>
                <div class="px-5">
                    <div class="d-flex row">
                        ...
                        <div class="col-md-6 col-12 pb-0 mb-0 my-3 ">
                            ...
                            <div class="d-flex flex-column">
                                <div>
                                    <div class="col-12 m-0 p-0 mt-2">
                                        <img src="{{ asset('assets/img/background/footer_section1_redux.jpg') }}" class="img-fluid mb-2 footer_section" alt="Preview 1">
